  ...
  return (
    <div className="min-h-screen pt-24 pb-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div ref={headerRef} className={`transition-all duration-700 ${headerVisible ? 'opacity-100' : 'opacity-0 translate-y-10'}`}>
          <SectionHeader 
            title="Get In Touch" 
        ...
        <div ref={cardsRef} className={`grid grid-cols-1 md:grid-cols-3 gap-8 mt-8 transition-all duration-700 delay-200 ${cardsVisible ? 'opacity-100' : 'opacity-0 translate-y-10'}`}>
        ...
        <div ref={quoteRef} className={`mt-12 bg-gradient-to-br from-primary/20 via-accent/15 to-blue-400/10 p-8 rounded-lg text-center transition-all duration-700 delay-400 ${quoteVisible ? 'opacity-100' : 'opacity-0 translate-y-10'}`}>
