        ...
        <div className="mt-4">
          ...
          <div className="mt-6 p-4 border border-border rounded-lg">
            <div className="flex items-center justify-between mb-4">
              <h4 className="text-base font-medium">Summary Depth</h4>
              <div className="text-sm text-muted-foreground">{visibleContent === 1 ? 'Basic' : visibleContent === 2 ? 'Detailed' : 'Complete'}</div>
            </div>
            <Slider
              defaultValue={[1]}
              max={3}
          ...
          <div className="mt-4 text-center">
            <p className="text-sm text-muted-foreground italic">
              For access to the complete research paper, please contact me directly.
            </p>
          </div>
        </div>
      </div>
