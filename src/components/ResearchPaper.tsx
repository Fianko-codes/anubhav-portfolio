  ...
  return (
    <div className="mb-12">
      <div className="relative">
          ...
          <div className="relative">
            ...
            <div className="absolute bottom-0 left-0 w-full p-4">
              <div className="flex justify-between items-end">
                <Badge variant="secondary" className="mb-2">NMMC Winner 2025</Badge>
        ...
        <div className="mt-4">
          <h3 className="text-xl font-bold">A Mathematical Model for Analyzing Bus Waiting Times Under Stochastic Delays</h3>
          ...
          <div className="mt-4 flex flex-wrap gap-2">
            <Badge variant="outline" className="bg-background/50">Monte Carlo Simulation</Badge>
            <Badge variant="outline" className="bg-background/50">Stochastic Modeling</Badge>
            <Badge variant="outline" className="bg-background/50">Transportation Planning</Badge>
            <Badge variant="outline" className="bg-background/50">Probability Distribution</Badge>
          </div>
